...
This file tracks official documentation that can support system design claims.
...
- [Google Cloud AI/ML Architecture Center](https://cloud.google.com/architecture/ai-ml)
